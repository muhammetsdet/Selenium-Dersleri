...
*/
        ...
        System.out.println("errorMessage = " + errorMessage);//Mesaj boş dönüyor çünkü sekronizayson problemi var.

        //Sekronizasyon problemini explicitWait ile çözelim
        //1.Adım Wait objesi oluştur.
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        //2.Adım Obje ile until methodunu kullanmak
        WebElement errorMessageAfterWait = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("error")));
        System.out.println("errorMessageAfterWait = " + errorMessageAfterWait.getText());
...
//Click işlemi sonrası istenilen elemntin gelmesi 10 saniye alacağından elementin görünür olmasını bekleyecek bir Fluent Wait koyalım
        //1.Adım: Fluent wait objesi oluştur
        FluentWait<WebDriver> wait = new FluentWait<>(driver)
                .withTimeout(Duration.ofSeconds(20))//Toplam bekleme süresi
                .pollingEvery(Duration.ofSeconds(2))//Her iki saniyede bir elementin varlığını kontrol eder
