 ...
 */
 ...
 /*
    ...
    Select the Default Label Select Menu using the element id.
...
//        Locate the Default Label Select Menu using the element id.
WebElement defaultLabel= driver.findElement(By.id("demo_label"));
        Select select = new Select(defaultLabel);//Select contructor WebElement parametresi kabul eder.
//        Print all the options of the dropdown.
...
//        }
optionsList.forEach(t-> System.out.println(t.getText()));//Lambda kullanmak tercih edilir.
