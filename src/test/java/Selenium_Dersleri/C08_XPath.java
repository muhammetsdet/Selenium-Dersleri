...
driver.get("https://thinking-tester-contact-list.herokuapp.com/");
   ...
   WebElement signUpButton = driver.findElement(By.xpath("/html/body/div[3]/button"));//Yani buraya click(); yazılamsı önerilmez.
        signUpButton.click();
    }
    ...
    public void relativeXPathNegativeTest() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//button[@id='submit']")).click();
        Thread.sleep(2000);//Sekranizosyon için beklemesi gerekiyor yoksa hata mesajını alamaz çünkü mesaj gelmeden okumasını bekleriz ama gelemez ve test geçmez.
